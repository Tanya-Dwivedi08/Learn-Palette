...
const ResetPassword = () => {
  ...
  const checkMailExists = async () => {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/student/getbymail/${emailRef.current.value}`
    );
          ...
          <div className="w-full p-6 bg-purple-50 rounded-lg shadow dark:border md:mt-0 sm:max-w-md dark:bg-gray-800 dark:border-gray-700 sm:p-8">
            ...
            <div>
              <button
                type="Submit"
                onClick={sendOTP}
                className="mt-2 radius-xl bg-[#7f746a] border border-[#c8bcaf] w-1/2 rounded-lg"
              >
                Send OTP
              </button>
            </div>
            ...
            <div>
              <button
                onClick={verifyOTP}
                className="mt-2 radius-xl bg-[#c2b3a5] border border-[#c2b3a5] w-1/2 rounded-lg"
              >
                Verify OTP
              </button>
            </div>
