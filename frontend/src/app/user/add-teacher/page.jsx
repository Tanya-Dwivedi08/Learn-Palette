                ...
                <div className="w-full flex-1 mt-8">
                  ...
                  <form onSubmit={teacherForm.handleSubmit}>
                    <div className="mx-auto max-w-xs">
                      ...
                      {
                        teacherForm.touched.fname &&
                        <small class="text-red-500">{teacherForm.errors.fname}</small>
                      }
                      <input
                        ...
                        value={teacherForm.values.fname}

                      />
                      {
                        teacherForm.touched.lname &&
                        <small class="text-red-500">{teacherForm.errors.lname}</small>
                      }
                      <input
                        className="w-full px-8 py-4 mb-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                        type="text"
                        ...
                        id="lname"
                        onChange={teacherForm.handleChange}
                        value={teacherForm.values.lname}

                      />

                      {
                        teacherForm.touched.email &&
                        <small class="text-red-500">{teacherForm.errors.email}</small>
                      }
                      <input
                      ...
                      />
                      {
                        teacherForm.touched.password &&
                        <small class="text-red-500">{teacherForm.errors.password}</small>
                      }
                      <input
                      ...
                      />
                      {
                        teacherForm.touched.cpassword &&
                        <small class="text-red-500">{teacherForm.errors.cpassword}</small>
                      }
                      <input
                        className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5"
                        type="cpassword"
                        ...
                        id="cpassword"
                        onChange={teacherForm.handleChange}
                        value={teacherForm.values.cpassword}
